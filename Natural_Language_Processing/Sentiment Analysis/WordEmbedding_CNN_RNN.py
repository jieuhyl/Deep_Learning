# -*- coding: utf-8 -*-
"""
Created on Tue Jun 30 01:43:31 2020
...
from keras.layers import Embedding, Input, Dense, add, CuDNNLSTM, CuDNNGRU, GRU, concatenate, Bidirectional, SpatialDropout1D, Conv1D, GlobalAveragePooling1D, GlobalMaxPooling1D
...
for i in range(n_seeds):
    model, _ = build_model(lr = 0.01, lr_d = 0.001, dr = 0.1)
    pred += model.predict(test_text, batch_size = 256, verbose = 1)/n_seeds
...
Epoch 1/5
1275904/1624386 [======================>.......] - ETA: 3:28 - loss: 0.1369 - acc: 0.9474
len(submission)
97320